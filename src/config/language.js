export default {
  ...
  today_text: "TODAY EARNING",
  gross_earning: "TOTAL EARNINGS",
  admin_convenience_fee: "Our Earning",
  this_month_text: "MONTHLY EARNING",
  total: "TOTAL EARNING",
  ...
  Papers: "Bike/Car Papers",
  Selfie: "Selfie Image",
  vehicle_number: "Vehicle Number",
  wallet_balance: "Wallet Balance",
  pending_commition: "Pending Commition",
  ...
  zones: "Zones",
  zones_title_heading: "Create and modify your assignment zones",
  zones_title_description:
    "if your company covers a large area, you might need to divide it into zones, to determine assignment rules according to these. Note that these zones are different from the Tariff Zones.",
