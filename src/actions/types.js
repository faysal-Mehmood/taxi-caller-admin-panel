...
export const FETCH_VEHICLE_TYPES_FAILED = 'FETCH_VEHICLE_TYPES_FAILED';
export const FETCH_VEHICLE_TYPES_SUCCESS = 'FETCH_VEHICLE_TYPES_SUCCESS';
export const EDIT_VEHICLE_TYPE = 'EDIT_VEHICLE_TYPE';
export const EDIT_VEHICLE_TAGS = 'EDIT_VEHICLE_TAGS';
export const FETCH_VEHICLE_TAGS_SUCCESS = 'FETCH_VEHICLE_TAGS_SUCCESS';
export const FETCH_VEHICLE_TAGS_FAILED = 'FETCH_VEHICLE_TAGS_FAILED';
