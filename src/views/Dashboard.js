...
const Dashboard = () => {
    ...
    return (
        ...
        <div>
            <Grid style={{backgroundColor:'orange'}} container direction="row" spacing={2}>
                <Grid item xs>
            ...
            <Paper style={{marginTop:'25px'}}>
                <Typography variant="h6" style={{padding:"10px 0 10px 15px", backgroundColor:'orange', color:'white'}}>{languageJson.real_time_driver_section_text}</Typography>
