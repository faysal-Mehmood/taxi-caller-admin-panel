...
import { editPromo } from '../actions/promoactions';
...
export default function Promos() {
  const columns = [
    ...
    {
      title: languageJson.promo_discount_value,
      field: 'promo_discount_value',
      type: 'numeric',
    },
    {
      title: languageJson.max_limit,
    ...
    {
      title: languageJson.promo_usage,
      field: 'promo_usage_limit',
      type: 'numeric',
    },
    {
      title: languageJson.promo_used_by,
      field: 'promo_used_by',
      editable: 'never',
    },
  ];
  ...
  const removeExtraKeys = (tblData) => {
    if (tblData.promo_discount_value)
      tblData.promo_discount_value = parseFloat(tblData.promo_discount_value);
    if (tblData.max_promo_discount_value)
      tblData.max_promo_discount_value = parseFloat(
        tblData.max_promo_discount_value
      );
    if (tblData.min_order) tblData.min_order = parseFloat(tblData.min_order);
    if (tblData.promo_usage_limit)
      tblData.promo_usage_limit = parseFloat(tblData.promo_usage_limit);
    return tblData;
  };
